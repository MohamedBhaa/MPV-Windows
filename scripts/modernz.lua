...
local user_opts = {
    ...
    jump_more_amount = 80,              -- change the jump amount in seconds when right-clicking jump buttons and shift-clicking chapter skip buttons
    ...
    track_nextprev_buttons = false,     -- show next/previous playlist track buttons
    ...
    loop_in_pause = false,           -- enable looping by right-clicking pause
    ...
    -- Colors and style
    osc_color = "#1E1E2E",                  -- accent color of the OSC and title bar
    window_title_color = "#CDD6F4",         -- color of the title in borderless/fullscreen mode
    window_controls_color = "#CDD6F4",      -- color of the window controls (close, minimize, maximize) in borderless/fullscreen mode
    ...
    title_color = "#CDD6F4",                -- color of the title (above seekbar)
    cache_info_color = "#CDD6F4",           -- color of the cache information
    seekbarfg_color = "#CBA6F7",            -- color of the seekbar progress and handle
    seekbarbg_color = "#1E1E2E",            -- color of the remaining seekbar
    seekbar_cache_color = "#B4BEFE",        -- color of the cache ranges on the seekbar
    volumebar_match_seek_color = true,      -- match volume bar color with seekbar color (ignores side_buttons_color)
    time_color = "#181825",                 -- color of the timestamps (below seekbar)
    chapter_title_color = "#CDD6F4",        -- color of the chapter title (above seekbar)
    side_buttons_color = "#CDD6F4",         -- color of the side buttons (audio, subtitles, playlist, etc.)
    middle_buttons_color = "#CDD6F4",       -- color of the middle buttons (skip, jump, chapter, etc.)
    playpause_color = "#CDD6F4",            -- color of the play/pause button
    held_element_color = "#89B4FA",         -- color of the element when held down (pressed)
    hover_effect_color = "#B4BEFE",         -- color of a hovered button when hover_effect includes "color"
    thumbnail_border_color = "#CBA6F7",     -- color of the border for thumbnails (with thumbfast)
    thumbnail_border_outline = "#F38BA8",   -- color of the border outline for thumbnails
